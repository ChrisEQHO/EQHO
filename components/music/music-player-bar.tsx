...
export function MusicPlayerBar() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-50 border-t border-white/10 bg-[#050414]/95 backdrop-blur-xl">
      <div className="mx-auto flex max-w-6xl items-center gap-3 px-4 py-3 sm:px-6">
        <div className="h-12 w-12 overflow-hidden rounded-md">
          <ArtworkPlaceholder accent={track.accent} />
        </div>
        ...
        <button
          ...
          className="grid h-11 w-11 place-items-center rounded-full bg-gradient-to-br from-[#ff4fa3] to-[#ff8a00] text-white transition-transform hover:scale-105"
        >
          {isPlaying ? (

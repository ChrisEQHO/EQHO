...
// Canonical TypeScript definitions for the eqho-audio plugin. The package is
// intentionally build-free: the published entry points are the hand-written
// root `index.js` / `index.d.ts`. This `src/` copy is the readable source of
// truth and mirrors `../index.d.ts` exactly.

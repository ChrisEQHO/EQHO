...
export default function Page() {
  ...
  <span className="text-[10px] text-white/50">{visiblePlaylist.length} tracks{hiddenTrackIds.size > 0 ? ` (${hiddenTrackIds.size} hidden)` : ''}</span>
      ...
      {/* Main Content Area */}
      <main className="md:ml-[76px] h-[calc(100vh-104px)] overflow-y-auto overflow-x-auto w-full max-w-full min-w-0 pt-14 md:pt-3 px-4">

        {activePage === "player" && (
          <div className="grid w-full max-w-full min-w-0 overflow-hidden gap-4 grid-cols-1 lg:grid-cols-[76px_280px_minmax(400px,1fr)_460px]">
            {/* LEFT: UPLOAD / TRACKS / PLAYLISTS */}
            <div className="hidden lg:flex flex-col gap-3 h-full w-[280px] shrink-0 overflow-hidden">
...
<Card className="relative flex flex-1 min-h-[400px] flex-col overflow-hidden">
      ...
      <div className="fixed bottom-0 left-0 right-0 w-full max-w-none min-w-0 overflow-hidden lg:left-[84px] z-40 h-[104px] bg-[#050816] pb-[env(safe-area-inset-bottom)]">

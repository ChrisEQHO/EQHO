...
function Card({ children, className = "" }: { children: React.ReactNode; className?: string }) {
  return (
    <div className={`rounded-xl border border-white/10 bg-[#0c1e30]/85 shadow-[0_0_35px_rgba(0,180,255,0.05)] ${className}`}>
      {children}
    </div>
  );
}
...
export default function Page() {
  ...
  return (
    <div className="relative h-screen overflow-hidden bg-[#080f18] text-white">
      ...
      <div
        ref={fullscreenRef}
        className={`${isFullscreen ? 'flex' : 'hidden'} fixed inset-0 z-[100] bg-[#0c1e30] text-white`}
      >
        {/* Safety Confirmation Dialogs */}
        {showPauseConfirm && (
          <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/70">
            <div className="bg-[#0c1e30]/90 backdrop-blur-xl border border-white/20 rounded-2xl p-8 max-w-md text-center shadow-[0_0_40px_rgba(0,0,0,0.5)]">
        ...
        {showFullscreenQueuePlaylist && (
          <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/70">
            <div className="bg-[#0c1e30]/90 backdrop-blur-xl border border-white/20 rounded-2xl p-6 w-[400px] max-h-[500px] flex flex-col shadow-[0_0_40px_rgba(0,0,0,0.5)]">
        ...
        <div className="flex w-full h-full p-4 gap-4">
          ...
          <div className="flex-[2] flex flex-col bg-[#0c1e30]/80 backdrop-blur-xl rounded-2xl border border-white/10 p-6 min-w-0 overflow-hidden shadow-[0_0_30px_rgba(0,0,0,0.3)]">
            {/* Header */}
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <div
                  className="relative flex items-center justify-center w-[120px] h-10 rounded-lg border border-white/10 bg-[#0c1e30] cursor-pointer overflow-hidden"
                  onClick={(e) => {
          ...
          <div className="flex-1 flex flex-col bg-[#0c1e30]/80 backdrop-blur-xl rounded-2xl border border-white/10 p-4 min-w-[280px] max-w-[350px] overflow-hidden shadow-[0_0_30px_rgba(0,0,0,0.3)]">
      ...
      <aside
        ...
        className={`fixed left-0 top-0 z-50 hidden md:flex h-screen flex-col bg-[#0c1e30]/95 backdrop-blur-xl border-r border-white/10 transition-all duration-300 overflow-hidden ${
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 flex md:hidden items-center justify-between px-3 py-2 bg-[#0c1e30]/95 backdrop-blur-xl border-b border-white/10">
        ...
        {activePage === "player" && (
          <div className="grid grid-cols-1 lg:grid-cols-[360px_420px_minmax(0,1fr)] gap-4 md:gap-6">
            ...
            <div className="flex flex-col gap-3 md:gap-4 order-first lg:order-none">
              <Card className="relative flex-1 overflow-hidden bg-[#0c1e30] p-3 md:p-4">
    ...
    Clear Playlist
            ...
            <div className="mb-4 md:mb-6 flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                ...
                <div
                  className="relative flex items-center justify-center w-[100px] md:w-[145px] h-[38px] md:h-[46px] rounded-lg border border-white/10 bg-[#0c1e30] cursor-pointer overflow-hidden"
                  onClick={(e) => {
                    const rect = e.currentTarget.getBoundingClientRect();
                    const x = e.clientX - rect.left;
                    const pct = Math.round(Math.max(0, Math.min(100, (x / rect.width) * 100)));
...
<Card className="relative flex flex-1 min-h-[560px] flex-col overflow-hidden">
      ...
      <div className="fixed bottom-0 left-0 md:left-[76px] right-0 z-40 overflow-hidden bg-[#0c1e30]">
      ...
      {showStopConfirm && (
        <div className="fixed inset-0 z-[80] flex items-center justify-center bg-black/70 backdrop-blur-sm">
          <div className="w-full max-w-sm rounded-2xl border border-orange-500/30 bg-[#0c1e30] p-6 shadow-2xl">
      ...
      {showPlaylistModal && (
        <div className="fixed inset-0 z-[70] flex items-center justify-center bg-black/60 backdrop-blur-sm">
          <div className="w-full max-w-md rounded-2xl border border-white/15 bg-[#0c1e30] p-6 shadow-2xl">
